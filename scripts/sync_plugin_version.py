...
PLUGIN_JSON_PATH = ROOT / "webfission-creative" / ".hermes-skill" / "plugin.json"
MARKETPLACE_JSON_PATH = ROOT / ".hermes-skill" / "marketplace.json"
README_PATH = ROOT / "README.md"
PLUGIN_NAME = "webfission-creative"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync Hermes plugin release metadata")
    parser.add_argument(
        "--check",
        action="store_true",
