...
class ContextManager:
    ...
    def _load_genre_profile(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        profile_path = self.config.project_root / ".hermes" / "references" / "genre-profiles.md"
        taxonomy_path = self.config.project_root / ".hermes" / "references" / "reading-power-taxonomy.md"
