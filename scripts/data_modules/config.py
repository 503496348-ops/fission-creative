...
def _get_user_hermes_root() -> Path:
    raw = os.environ.get("WEBNOVEL_HERMES_HOME") or os.environ.get("HERMES_HOME")
    if raw:
        try:
...
def get_config(project_root: Optional[Path] = None) -> DataModulesConfig:
    ...
    if _default_config is None:
        ...
        # - 支持 `.hermes/.webnovel-current-project` 指针文件
