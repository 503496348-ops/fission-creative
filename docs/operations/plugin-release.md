...
```bash
python -X utf8 webfission-creative/scripts/sync_plugin_version.py --version X.Y.Z --release-notes "本次版本说明"
```

该命令会自动更新以下文件中的版本信息：

- `webfission-creative/.hermes-plugin/plugin.json`
...
- `.hermes-plugin/marketplace.json`
- `webfission-creative/.hermes-plugin/plugin.json`
- `webfission-creative/scripts/sync_plugin_version.py`
- `README.md`
