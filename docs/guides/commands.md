...
```bash
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" <子命令> [参数]
```
...
```bash
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" story-system "玄幻退婚流" --chapter 12 --persist --emit-runtime-contracts --format both
```

2. 提交章节

```bash
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" chapter-commit \
  --chapter 12 \
...
```bash
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" preflight --format json
```
...
```bash
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" memory stats
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" memory query --category character_state --subject xiaoyan
```
...
```bash
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" story-system "玄幻退婚流" --persist
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" chapter-commit --chapter 12 --review-result .webnovel/tmp/review.json
python -X utf8 "<SKILL_ROOT_DIR>/scripts/webnovel.py" --project-root "<PROJECT_ROOT>" story-events --health
```
