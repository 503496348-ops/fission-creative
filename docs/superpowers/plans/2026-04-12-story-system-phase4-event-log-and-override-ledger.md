...
- `webfission-creative/scripts/story_events.py`
- `webfission-creative/scripts/data_modules/story_event_schema.py`
- `webfission-creative/scripts/data_modules/event_log_store.py`
- `webfission-creative/scripts/data_modules/event_projection_router.py`
- `webfission-creative/scripts/data_modules/amend_proposal_schema.py`
- `webfission-creative/scripts/data_modules/override_ledger_service.py`
- `webfission-creative/scripts/data_modules/tests/test_story_event_schema.py`
- `webfission-creative/scripts/data_modules/tests/test_event_log_store.py`
- `webfission-creative/scripts/data_modules/tests/test_event_projection_router.py`
- `webfission-creative/scripts/data_modules/tests/test_override_ledger_service.py`
- `docs/architecture/story-system-phase4.md`

### 要修改的文件

- `webfission-creative/scripts/data_modules/chapter_commit_service.py`
- `webfission-creative/scripts/data_modules/index_manager.py`
- `webfission-creative/scripts/data_modules/index_debt_mixin.py`
- `webfission-creative/scripts/data_modules/index_observability_mixin.py`
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/story_event_schema.py`
- Create: `webfission-creative/scripts/data_modules/event_log_store.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_story_event_schema.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_event_log_store.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_story_event_schema.py webfission-creative/scripts/data_modules/tests/test_event_log_store.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/story_event_schema.py \
        webfission-creative/scripts/data_modules/event_log_store.py \
        webfission-creative/scripts/data_modules/tests/test_story_event_schema.py \
        webfission-creative/scripts/data_modules/tests/test_event_log_store.py \
        webfission-creative/scripts/data_modules/chapter_commit_service.py
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/event_projection_router.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_event_projection_router.py`
- Modify: `webfission-creative/scripts/data_modules/state_projection_writer.py`
- Modify: `webfission-creative/scripts/data_modules/index_projection_writer.py`
- Modify: `webfission-creative/scripts/data_modules/memory_projection_writer.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_event_projection_router.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/event_projection_router.py \
        webfission-creative/scripts/data_modules/tests/test_event_projection_router.py \
        webfission-creative/scripts/data_modules/state_projection_writer.py \
        webfission-creative/scripts/data_modules/index_projection_writer.py \
        webfission-creative/scripts/data_modules/memory_projection_writer.py
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/amend_proposal_schema.py`
- Create: `webfission-creative/scripts/data_modules/override_ledger_service.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_override_ledger_service.py`
- Modify: `webfission-creative/scripts/data_modules/index_manager.py`
- Modify: `webfission-creative/scripts/data_modules/index_debt_mixin.py`
- Modify: `webfission-creative/scripts/data_modules/index_observability_mixin.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_override_ledger_service.py -q --no-cov`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_override_ledger_service.py webfission-creative/scripts/data_modules/tests/test_data_modules.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/amend_proposal_schema.py \
        webfission-creative/scripts/data_modules/override_ledger_service.py \
        webfission-creative/scripts/data_modules/tests/test_override_ledger_service.py \
        webfission-creative/scripts/data_modules/index_manager.py \
        webfission-creative/scripts/data_modules/index_debt_mixin.py \
...
**Files:**
- Create: `webfission-creative/scripts/story_events.py`
...
- Modify: `webfission-creative/scripts/data_modules/tests/test_event_log_store.py`
...
```bash
git add webfission-creative/scripts/story_events.py \
        webfission-creative/scripts/data_modules/webnovel.py \
        webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py \
        webfission-creative/scripts/data_modules/tests/test_event_log_store.py \
        webfission-creative/dashboard/app.py \
