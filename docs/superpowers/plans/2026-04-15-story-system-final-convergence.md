...
| 文件 | 职责 |
|------|------|
| `webfission-creative/references/csv/裁决规则.csv` | reasoning 层，key=题材，裁决命中条目的优先级和注入位置 |
| `webfission-creative/scripts/data_modules/knowledge_query.py` | 时序查询接口，entity_state_at_chapter / relationships_at_chapter |
| `webfission-creative/scripts/data_modules/vector_projection_writer.py` | commit 后把事件/entity_delta 写入向量库 |
| `webfission-creative/scripts/data_modules/tests/test_csv_config.py` | CSV_CONFIG 与 CSV 表头对齐校验 |
| `webfission-creative/scripts/data_modules/tests/test_reasoning_engine.py` | 裁决层单元测试 |
| `webfission-creative/scripts/data_modules/tests/test_knowledge_query.py` | 时序查询单元测试 |
| `webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py` | 向量投影写入测试 |

### 主要修改文件

| 文件 | 改动摘要 |
|------|---------|
| `webfission-creative/scripts/reference_search.py` | 引入 `CSV_CONFIG`，`search()` 按表使用不同 `search_cols` |
| `webfission-creative/scripts/data_modules/story_system_engine.py` | 接入裁决表，新增 `_load_reasoning` / `_apply_reasoning` / `_rank_anti_patterns` / `_assemble_contract` |
| `webfission-creative/scripts/data_modules/context_manager.py` | 删 snapshot 逻辑、删 `_compact_json_text` / text 渲染相关，压到 400 行以下 |
| `webfission-creative/scripts/extract_chapter_context.py` | `_render_text()` 改为纯 JSON 序列化，text 渲染不再由代码层负责（context-agent 按示例写任务书） |
| `webfission-creative/scripts/data_modules/event_projection_router.py` | 给 6 种事件加 `"vector"` 路由 |
| `webfission-creative/scripts/data_modules/chapter_commit_service.py` | `apply_projections` 接入 `VectorProjectionWriter` |
| `webfission-creative/scripts/data_modules/state_projection_writer.py` | 统一由 projection 推进 `chapter_status` |
| `webfission-creative/skills/webnovel-write/SKILL.md` | 删 Step 2/4 的 `set-chapter-status`、删 `core-constraints` / `anti-ai-guide` 直读 |
| `webfission-creative/agents/context-agent.md` | 确认工具段落、research 数据源路径与代码一致 |
| `webfission-creative/agents/data-agent.md` | 确认不直写 state/index/memory |
| `webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py` | 新增散写检测断言 |
| `webfission-creative/scripts/data_modules/tests/test_event_projection_router.py` | 补 vector 路由测试 |
| `webfission-creative/scripts/data_modules/tests/test_story_system_engine.py` | 补裁决层测试 |
| `webfission-creative/scripts/tests/test_reference_search.py` | 补 per-table search_cols 测试 |
| `webfission-creative/references/csv/*.csv` | 毒点列统一 rename |

### 删除文件

| 文件 | 理由 |
|------|------|
| `webfission-creative/scripts/data_modules/snapshot_manager.py` | snapshot 逻辑随 context_manager 瘦身一起删除 |
...
**Files:**
- Modify: `webfission-creative/scripts/reference_search.py:90-191`
- Create: `webfission-creative/scripts/data_modules/tests/test_csv_config.py`
- Modify: `webfission-creative/scripts/tests/test_reference_search.py`
...
```python
# webfission-creative/scripts/data_modules/tests/test_csv_config.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_csv_config.py -v`

预期：`裁决规则` 那条会 skip（文件还没创建），其余表全 pass。

- [ ] **Step 7: 补充 per-table 检索测试**

在 `webfission-creative/scripts/tests/test_reference_search.py` 末尾新增：
...
Run: `cd webfission-creative && python -m pytest scripts/tests/test_reference_search.py -v`
...
```bash
git add webfission-creative/scripts/reference_search.py webfission-creative/scripts/data_modules/tests/test_csv_config.py webfission-creative/scripts/tests/test_reference_search.py
...
**Files:**
- Modify: `webfission-creative/references/csv/场景写法.csv` (header rename)
- Modify: `webfission-creative/references/csv/写作技法.csv` (header rename)
- Modify: `webfission-creative/references/csv/爽点与节奏.csv` (header rename)
- Modify: `webfission-creative/references/csv/人设与关系.csv` (header rename)
- Modify: `webfission-creative/references/csv/桥段套路.csv` (header rename)
- Modify: `webfission-creative/references/csv/题材与调性推理.csv` (header rename)
- Modify: `webfission-creative/scripts/data_modules/story_system_engine.py:15-22`
...
csv_dir = Path('webfission-creative/references/csv')
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_csv_config.py scripts/data_modules/tests/test_story_system_engine.py scripts/tests/test_reference_search.py -v`
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_story_system_engine.py scripts/data_modules/tests/test_csv_config.py -v`
...
```bash
git add webfission-creative/references/csv/*.csv webfission-creative/scripts/data_modules/story_system_engine.py webfission-creative/scripts/data_modules/tests/test_story_system_engine.py
...
**Files:**
- Create: `webfission-creative/references/csv/裁决规则.csv`
...
```bash
git add webfission-creative/references/csv/裁决规则.csv
...
**Files:**
- Modify: `webfission-creative/scripts/data_modules/story_system_engine.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_reasoning_engine.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_story_system_engine.py`

- [ ] **Step 1: 写裁决层测试**

```python
# webfission-creative/scripts/data_modules/tests/test_reasoning_engine.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""裁决层集成测试。"""
import csv
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_reasoning_engine.py -v`
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_story_system_engine.py -v`
...
```bash
git add webfission-creative/scripts/data_modules/story_system_engine.py webfission-creative/scripts/data_modules/tests/test_reasoning_engine.py
...
**Files:**
- Modify: `webfission-creative/scripts/data_modules/context_manager.py`
- Delete: `webfission-creative/scripts/data_modules/snapshot_manager.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_context_manager.py`
...
```bash
git rm webfission-creative/scripts/data_modules/snapshot_manager.py
```
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_context_manager.py scripts/data_modules/tests/test_extract_chapter_context.py -v`

预期：全部 PASS。

- [ ] **Step 12: 确认行数**

Run: `wc -l webfission-creative/scripts/data_modules/context_manager.py`
...
```bash
git add webfission-creative/scripts/data_modules/context_manager.py webfission-creative/scripts/extract_chapter_context.py webfission-creative/scripts/data_modules/tests/test_context_manager.py
git rm webfission-creative/scripts/data_modules/snapshot_manager.py
...
**Files:**
- Modify: `webfission-creative/skills/webnovel-write/SKILL.md:184,254,323`
- Modify: `webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py`
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_prompt_integrity.py -v`
...
```bash
git add webfission-creative/skills/webnovel-write/SKILL.md webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py
...
- Modify: `webfission-creative/scripts/data_modules/state_projection_writer.py`
- Modify: `webfission-creative/scripts/data_modules/chapter_commit_service.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_event_projection_router.py`
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_event_projection_router.py -v`
...
```bash
git add webfission-creative/scripts/data_modules/event_projection_router.py webfission-creative/scripts/data_modules/state_projection_writer.py webfission-creative/scripts/data_modules/tests/test_event_projection_router.py
...
**Files:**
- Modify: `webfission-creative/agents/context-agent.md`
- Modify: `webfission-creative/agents/data-agent.md`
- Modify: `webfission-creative/skills/webnovel-write/SKILL.md`
- Modify: `webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py`
...
```bash
git add webfission-creative/agents/context-agent.md webfission-creative/agents/data-agent.md webfission-creative/skills/webnovel-write/SKILL.md webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/vector_projection_writer.py`
- Modify: `webfission-creative/scripts/data_modules/chapter_commit_service.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py`
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_vector_projection_writer.py -v`
...
```bash
git add webfission-creative/scripts/data_modules/vector_projection_writer.py webfission-creative/scripts/data_modules/chapter_commit_service.py webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/knowledge_query.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_knowledge_query.py`
- Modify: `webfission-creative/scripts/data_modules/webnovel.py` (register CLI subcommand)
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/test_knowledge_query.py -v`
...
在 `webfission-creative/scripts/data_modules/webnovel.py` 中注册 `knowledge` 子命令。找到 subparser 注册区域（grep `add_parser`），新增：
...
Run: `cd webfission-creative && python -m pytest scripts/data_modules/tests/ scripts/tests/ -v --timeout=60`
...
```bash
git add webfission-creative/scripts/data_modules/knowledge_query.py webfission-creative/scripts/data_modules/tests/test_knowledge_query.py webfission-creative/scripts/data_modules/webnovel.py webfission-creative/agents/context-agent.md webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py
...
```bash
cd webfission-creative && python -m pytest scripts/data_modules/tests/ scripts/tests/ -v --timeout=120
```
...
```bash
grep -rn "state set-chapter-status" webfission-creative/skills/ webfission-creative/agents/ || echo "CLEAN"
grep -rn "index process-chapter" webfission-creative/skills/ webfission-creative/agents/ || echo "CLEAN"
```
...
```bash
wc -l webfission-creative/scripts/data_modules/context_manager.py
```
...
```bash
test -f webfission-creative/scripts/data_modules/snapshot_manager.py && echo "STILL EXISTS" || echo "DELETED"
```
...
import csv
from pathlib import Path
path = Path('webfission-creative/references/csv/裁决规则.csv')
...
```bash
cd webfission-creative && python -m pytest scripts/data_modules/tests/test_csv_config.py -v
```
