...
- `webfission-creative/references/csv/题材与调性推理.csv`
...
- `webfission-creative/scripts/data_modules/tests/test_story_contracts.py`
- `webfission-creative/scripts/data_modules/tests/test_story_system_engine.py`
- `webfission-creative/scripts/data_modules/tests/test_story_system_cli.py`
- `webfission-creative/scripts/story_system.py`
- `docs/architecture/story-system-phase1.md`

### 要修改的文件

- `webfission-creative/references/csv/README.md`
- `webfission-creative/references/csv/桥段套路.csv`
- `webfission-creative/scripts/data_modules/config.py`
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/story_contracts.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_story_contracts.py`
- Modify: `webfission-creative/scripts/data_modules/config.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_story_contracts.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/config.py \
        webfission-creative/scripts/data_modules/story_contracts.py \
        webfission-creative/scripts/data_modules/tests/test_story_contracts.py
...
**Files:**
- Create: `webfission-creative/references/csv/题材与调性推理.csv`
- Create: `webfission-creative/scripts/data_modules/story_system_engine.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_story_system_engine.py`
- Modify: `webfission-creative/references/csv/README.md`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_story_system_engine.py -q --no-cov`
...
```bash
git add webfission-creative/references/csv/题材与调性推理.csv \
        webfission-creative/references/csv/桥段套路.csv \
        webfission-creative/references/csv/README.md \
        webfission-creative/scripts/data_modules/story_system_engine.py \
        webfission-creative/scripts/data_modules/tests/test_story_system_engine.py
...
**Files:**
- Create: `webfission-creative/scripts/story_system.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_story_system_cli.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_story_system_cli.py webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/story_system.py \
        webfission-creative/scripts/data_modules/story_contracts.py \
        webfission-creative/scripts/data_modules/webnovel.py \
        webfission-creative/scripts/data_modules/tests/test_story_system_cli.py \
        webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_context_manager.py webfission-creative/scripts/data_modules/tests/test_extract_chapter_context.py -q --no-cov`
