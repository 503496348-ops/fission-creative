...
```bash
cd "D:\wk\novel skill\webfission-creative\webfission-creative" && python -m pytest scripts/data_modules/tests/test_csv_config.py scripts/data_modules/tests/test_reasoning_engine.py -v --tb=short
```

- [ ] **Step 5: Commit**

```bash
cd "D:\wk\novel skill\webfission-creative" && git add webfission-creative/references/csv/裁决规则.csv && git commit -m "fix: expand reasoning table genre aliases to cover init genre names"
```
...
```bash
grep -n "get-field" webfission-creative/scripts/data_modules/webnovel.py
```
...
```bash
git add webfission-creative/skills/webnovel-write/SKILL.md webfission-creative/skills/webnovel-plan/SKILL.md
...
**Files:**
- Modify: `webfission-creative/skills/webnovel-init/SKILL.md`
...
```bash
git add webfission-creative/skills/webnovel-init/SKILL.md
...
```bash
git add webfission-creative/agents/context-agent.md webfission-creative/skills/webnovel-write/SKILL.md
...
```bash
git add webfission-creative/skills/webnovel-plan/SKILL.md
...
```bash
cd "D:\wk\novel skill\webfission-creative\webfission-creative" && python -m pytest scripts/data_modules/tests/test_prompt_integrity.py -v --tb=short
```

- [ ] **Step 2: 运行 CSV 配置对齐测试**

```bash
cd "D:\wk\novel skill\webfission-creative\webfission-creative" && python -m pytest scripts/data_modules/tests/test_csv_config.py -v --tb=short
```
