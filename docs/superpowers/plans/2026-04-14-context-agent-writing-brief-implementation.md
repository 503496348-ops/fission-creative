...
- `webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py`
  - 锁定新的提示词边界
- `webfission-creative/skills/webnovel-write/evals/evals.json`
  - 更新流程预期
...
- `webfission-creative/scripts/data_modules/writing_brief_renderer.py`
- `webfission-creative/scripts/data_modules/tests/test_writing_brief_renderer.py`
...
**Files:**
- Delete: `webfission-creative/scripts/data_modules/writing_brief_renderer.py`
- Delete: `webfission-creative/scripts/data_modules/tests/test_writing_brief_renderer.py`
...
```bash
git rm webfission-creative/scripts/data_modules/writing_brief_renderer.py
git rm webfission-creative/scripts/data_modules/tests/test_writing_brief_renderer.py
```
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_extract_chapter_context.py -q --no-cov
```
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py -q --no-cov
```
...
```bash
git add webfission-creative/agents/context-agent.md \
        webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py
...
- Modify: `webfission-creative/skills/webnovel-write/evals/evals.json`
...
**Files:**
- Test: `webfission-creative/scripts/data_modules/tests/test_extract_chapter_context.py`
- Test: `webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py`
