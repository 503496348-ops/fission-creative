...
- `webfission-creative/scripts/data_modules/story_contract_schema.py`
- `webfission-creative/scripts/data_modules/runtime_contract_builder.py`
- `webfission-creative/scripts/data_modules/prewrite_validator.py`
- `webfission-creative/scripts/data_modules/tests/test_story_contract_schema.py`
- `webfission-creative/scripts/data_modules/tests/test_runtime_contract_builder.py`
- `webfission-creative/scripts/data_modules/tests/test_prewrite_validator.py`
- `docs/architecture/story-system-phase2.md`

### 要修改的文件

- `webfission-creative/scripts/data_modules/story_contracts.py`
- `webfission-creative/scripts/data_modules/story_system_engine.py`
- `webfission-creative/scripts/story_system.py`
...
- `webfission-creative/scripts/chapter_outline_loader.py`
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/story_contract_schema.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_story_contract_schema.py`
- Modify: `webfission-creative/scripts/data_modules/story_contracts.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_story_contract_schema.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/story_contract_schema.py \
        webfission-creative/scripts/data_modules/story_contracts.py \
        webfission-creative/scripts/data_modules/tests/test_story_contract_schema.py
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/runtime_contract_builder.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_runtime_contract_builder.py`
- Modify: `webfission-creative/scripts/data_modules/story_system_engine.py`
- Modify: `webfission-creative/scripts/data_modules/story_contracts.py`
- Modify: `webfission-creative/scripts/story_system.py`
- Modify: `webfission-creative/scripts/chapter_outline_loader.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_runtime_contract_builder.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/runtime_contract_builder.py \
        webfission-creative/scripts/data_modules/tests/test_runtime_contract_builder.py \
        webfission-creative/scripts/data_modules/story_contracts.py \
        webfission-creative/scripts/story_system.py \
        webfission-creative/scripts/chapter_outline_loader.py
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/prewrite_validator.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_prewrite_validator.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_prewrite_validator.py -q --no-cov`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_prewrite_validator.py webfission-creative/scripts/data_modules/tests/test_context_manager.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/prewrite_validator.py \
        webfission-creative/scripts/data_modules/tests/test_prewrite_validator.py \
        webfission-creative/scripts/data_modules/context_manager.py \
        webfission-creative/scripts/data_modules/tests/test_context_manager.py
...
def test_story_system_runtime_contract_commands_exist():
    ...
    text = Path("webfission-creative/skills/webnovel-write/SKILL.md").read_text(encoding="utf-8")
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py -q --no-cov`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py webfission-creative/scripts/data_modules/tests/test_extract_chapter_context.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/extract_chapter_context.py \
        webfission-creative/scripts/data_modules/webnovel.py \
        webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py \
        webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py \
        webfission-creative/skills/webnovel-plan/SKILL.md \
...
```bash
python -X utf8 "<HERMES_PLUGIN_ROOT>/scripts/webnovel.py" \
...
Run: `python -m pytest webfission-creative/scripts/tests/test_reference_search.py -q --no-cov`
