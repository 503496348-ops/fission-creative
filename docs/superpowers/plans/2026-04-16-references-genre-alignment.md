...
**Genre Canonical:** `webfission-creative/references/csv/genre-canonical.md`
...
**Files:**
- Modify: `webfission-creative/scripts/reference_search.py:84-154`
- Test: `webfission-creative/scripts/tests/test_reference_search.py`

- [ ] **Step 1: 写失败测试 — canonical 常量存在且完整**

在 `webfission-creative/scripts/tests/test_reference_search.py` 末尾添加：
...
Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python -m pytest tests/test_reference_search.py::TestGenreCanonical -v`
...
```bash
cd "D:/wk/novel skill/webfission-creative"
git add webfission-creative/scripts/reference_search.py webfission-creative/scripts/tests/test_reference_search.py
...
**Files:**
- Modify: `webfission-creative/scripts/reference_search.py:74-82, 294-335`
- Test: `webfission-creative/scripts/tests/test_reference_search.py`
...
Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python -m pytest tests/test_reference_search.py::TestGenreCanonical::test_search_with_platform_tag_genre -v`
...
Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python -m pytest tests/test_reference_search.py -v`
...
**Files:**
- Modify: `webfission-creative/scripts/reference_search.py:88-154`
- Modify: `webfission-creative/scripts/data_modules/tests/test_csv_config.py`
...
Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python -m pytest data_modules/tests/test_csv_config.py -v`
...
```bash
cd "D:/wk/novel skill/webfission-creative"
git add webfission-creative/scripts/reference_search.py webfission-creative/scripts/data_modules/tests/test_csv_config.py
...
**Files:**
- Create: `webfission-creative/scripts/validate_csv.py`
- Create: `webfission-creative/scripts/tests/test_validate_csv.py`

- [ ] **Step 1: 写失败测试 — validate_csv 模块可导入并执行**

创建 `webfission-creative/scripts/tests/test_validate_csv.py`：
...
Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python -m pytest tests/test_validate_csv.py -v`
Expected: FAIL — script not found

- [ ] **Step 3: 实现 validate_csv.py**

创建 `webfission-creative/scripts/validate_csv.py`：
...
Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python validate_csv.py`
...
```bash
cd "D:/wk/novel skill/webfission-creative"
git add webfission-creative/scripts/validate_csv.py webfission-creative/scripts/tests/test_validate_csv.py
...
**Files:**
- Modify: `webfission-creative/references/csv/题材与调性推理.csv`
- Modify: `webfission-creative/scripts/reference_search.py` (CSV_CONFIG for 题材与调性推理)
- Modify: `webfission-creative/scripts/data_modules/story_system_engine.py:115-159`

- [ ] **Step 1: 写失败测试 — engine route 输出包含 canonical_genre**

在 `webfission-creative/scripts/data_modules/tests/` 下找到或创建 `test_story_system_engine.py`，追加：
...
Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python -m pytest tests/ data_modules/tests/test_csv_config.py -v`
Expected: ALL PASS
...
```bash
cd "D:/wk/novel skill/webfission-creative"
git add webfission-creative/references/csv/题材与调性推理.csv webfission-creative/scripts/reference_search.py webfission-creative/scripts/data_modules/story_system_engine.py
...
**Files:**
- Modify: `webfission-creative/references/csv/命名规则.csv`
- Modify: `webfission-creative/references/csv/场景写法.csv`
- Modify: `webfission-creative/references/csv/写作技法.csv`
- Modify: `webfission-creative/references/csv/桥段套路.csv`
- Modify: `webfission-creative/references/csv/人设与关系.csv`
- Modify: `webfission-creative/references/csv/爽点与节奏.csv`
- Modify: `webfission-creative/references/csv/金手指与设定.csv`
- Modify: `webfission-creative/references/csv/裁决规则.csv`

**注意：此任务是手工数据修改。每个 CSV 需要逐行检查 `适用题材` 列，将非 canonical 值替换为 canonical 枚举值。**

- [ ] **Step 1: 运行 validate_csv.py 获取完整 warning 列表**

Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python validate_csv.py --format json > /tmp/csv_warnings.json`
...
```bash
cd "D:/wk/novel skill/webfission-creative"
git add webfission-creative/references/csv/*.csv
...
**Files:**
- Modify: `webfission-creative/references/csv/README.md:166-170`
...
```bash
cd "D:/wk/novel skill/webfission-creative"
git add webfission-creative/references/csv/README.md
...
**Files:**
- Create: `webfission-creative/references/README.md`
...
本目录存放 webfission-creative 的所有参考资料，供 skills 和 scripts 在运行时读取。
...
```bash
cd webfission-creative/scripts
...
```bash
cd "D:/wk/novel skill/webfission-creative"
git add webfission-creative/references/README.md
...
Run: `cd "D:/wk/novel skill/webfission-creative/webfission-creative/scripts" && python -m pytest tests/test_reference_search.py tests/test_validate_csv.py data_modules/tests/test_csv_config.py -v`
Expected: ALL PASS
...
```bash
cd "D:/wk/novel skill/webfission-creative"
git add webfission-creative/scripts/tests/test_reference_search.py
