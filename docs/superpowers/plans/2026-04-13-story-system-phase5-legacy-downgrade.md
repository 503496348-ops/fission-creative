...
- `webfission-creative/scripts/data_modules/story_runtime_sources.py`
- `webfission-creative/scripts/data_modules/story_runtime_health.py`
- `webfission-creative/scripts/data_modules/tests/test_story_runtime_sources.py`
- `webfission-creative/scripts/data_modules/tests/test_story_runtime_health.py`
- `docs/architecture/story-system-phase5.md`

### 要修改的文件

- `webfission-creative/scripts/data_modules/chapter_commit_service.py`
- `webfission-creative/scripts/data_modules/context_manager.py`
- `webfission-creative/scripts/data_modules/memory_contract_adapter.py`
- `webfission-creative/scripts/extract_chapter_context.py`
- `webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py`
- `webfission-creative/scripts/data_modules/tests/test_context_manager.py`
- `webfission-creative/scripts/data_modules/tests/test_memory_contract_adapter.py`
- `webfission-creative/scripts/data_modules/tests/test_extract_chapter_context.py`
- `webfission-creative/scripts/data_modules/webnovel.py`
- `webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py`
- `webfission-creative/dashboard/app.py`
- `webfission-creative/dashboard/frontend/src/App.jsx`
- `webfission-creative/dashboard/frontend/src/api.js`
- `webfission-creative/skills/webnovel-write/SKILL.md`
- `webfission-creative/skills/webnovel-review/SKILL.md`
- `webfission-creative/skills/webnovel-query/SKILL.md`
- `webfission-creative/skills/webnovel-plan/SKILL.md`
- `webfission-creative/skills/webnovel-dashboard/SKILL.md`
- `webfission-creative/agents/context-agent.md`
- `webfission-creative/agents/data-agent.md`
- `webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py`
- `webfission-creative/references/genre-profiles.md`
- `README.md`
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/story_runtime_sources.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_story_runtime_sources.py`
- Modify: `webfission-creative/scripts/data_modules/chapter_commit_service.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_story_runtime_sources.py webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/story_runtime_sources.py \
        webfission-creative/scripts/data_modules/chapter_commit_service.py \
        webfission-creative/scripts/data_modules/tests/test_story_runtime_sources.py \
        webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py
...
- Modify: `webfission-creative/scripts/data_modules/memory_contract_adapter.py`
- Modify: `webfission-creative/scripts/extract_chapter_context.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_context_manager.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_memory_contract_adapter.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_extract_chapter_context.py`
...
def test_context_manager_prefers_contract_route_over_legacy_genre_profile(temp_project):
    refs_dir = temp_project.project_root / ".hermes" / "references"
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_context_manager.py webfission-creative/scripts/data_modules/tests/test_memory_contract_adapter.py webfission-creative/scripts/data_modules/tests/test_extract_chapter_context.py -q --no-cov`
...
```bash
git add webfission-creative/scripts/data_modules/context_manager.py \
        webfission-creative/scripts/data_modules/memory_contract_adapter.py \
        webfission-creative/scripts/extract_chapter_context.py \
        webfission-creative/scripts/data_modules/tests/test_context_manager.py \
        webfission-creative/scripts/data_modules/tests/test_memory_contract_adapter.py \
...
- Modify: `webfission-creative/skills/webnovel-query/SKILL.md`
- Modify: `webfission-creative/skills/webnovel-plan/SKILL.md`
- Modify: `webfission-creative/skills/webnovel-dashboard/SKILL.md`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py -q --no-cov`
...
```bash
git add webfission-creative/skills/webnovel-write/SKILL.md \
        webfission-creative/skills/webnovel-review/SKILL.md \
        webfission-creative/skills/webnovel-query/SKILL.md \
        webfission-creative/skills/webnovel-plan/SKILL.md \
        webfission-creative/skills/webnovel-dashboard/SKILL.md \
...
**Files:**
- Create: `webfission-creative/scripts/data_modules/story_runtime_health.py`
- Create: `webfission-creative/scripts/data_modules/tests/test_story_runtime_health.py`
- Modify: `webfission-creative/scripts/data_modules/webnovel.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py`
- Modify: `webfission-creative/dashboard/app.py`
- Modify: `webfission-creative/dashboard/frontend/src/api.js`
- Modify: `webfission-creative/dashboard/frontend/src/App.jsx`
...
Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_story_runtime_health.py webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py -q --no-cov`
...
Run: `npm --prefix webfission-creative/dashboard/frontend run build`
...
```bash
git add webfission-creative/scripts/data_modules/story_runtime_health.py \
        webfission-creative/scripts/data_modules/webnovel.py \
        webfission-creative/scripts/data_modules/tests/test_story_runtime_health.py \
        webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py \
        webfission-creative/dashboard/app.py \
...
- Modify: `webfission-creative/references/genre-profiles.md`
- Modify: `README.md`
...
1. 生成合同：
   `python -X utf8 "webfission-creative/scripts/webnovel.py" --project-root "{WORKSPACE_ROOT}" story-system "{goal}" --chapter {N} --persist --emit-runtime-contracts --format both`
2. 提交章节：
   `python -X utf8 "webfission-creative/scripts/webnovel.py" --project-root "{PROJECT_ROOT}" chapter-commit --chapter {N} --review-result ".webnovel/tmp/review_results.json" --fulfillment-result ".webnovel/tmp/fulfillment_result.json" --disambiguation-result ".webnovel/tmp/disambiguation_result.json" --extraction-result ".webnovel/tmp/extraction_result.json"`
3. 检查健康：
   `python -X utf8 "webfission-creative/scripts/webnovel.py" --project-root "{PROJECT_ROOT}" preflight --format json`
```

- [ ] **Step 4: 做一次最终回归**

Run: `python -m pytest webfission-creative/scripts/data_modules/tests/test_prompt_integrity.py webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py webfission-creative/scripts/data_modules/tests/test_context_manager.py webfission-creative/scripts/data_modules/tests/test_memory_contract_adapter.py -q --no-cov`
