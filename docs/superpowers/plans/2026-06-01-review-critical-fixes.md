...
- `webfission-creative/scripts/chapter_commit.py`: CLI entry point; rejected commit must also run state projection.
- `webfission-creative/scripts/data_modules/chapter_commit_service.py`: projection orchestration; non-accepted commits should still allow the state writer rejected branch.
- `webfission-creative/scripts/data_modules/event_projection_router.py`: writer selection; rejected commits require `state`.
- `webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py`: service-level projection behavior tests.
- `webfission-creative/scripts/data_modules/tests/test_projection_writers.py`: end-to-end projection regression tests.

### Test Infrastructure

- `pytest.ini`: remove async plugin bans; keep coverage settings.
- `webfission-creative/scripts/data_modules/tests/test_rag_adapter.py`: existing async tests should run normally after config fix.

### CLI JSON Input Boundary

- `webfission-creative/scripts/data_modules/cli_args.py`: add optional base-dir containment for `@file` JSON arguments while keeping stdin/direct JSON behavior unchanged.
- `webfission-creative/scripts/data_modules/index_manager.py`: pass project-root containment to `load_json_arg()` for write/input JSON commands.
- `webfission-creative/scripts/data_modules/state_manager.py`: pass project-root containment to `load_json_arg()` for `process-chapter`.
- `webfission-creative/scripts/data_modules/sql_state_manager.py`: pass project-root containment to `load_json_arg()` for chapter entity processing.
- `webfission-creative/scripts/data_modules/memory/store.py`: pass project-root containment to `load_json_arg()` for memory upserts/imports.
- `webfission-creative/scripts/data_modules/rag_adapter.py`: pass project-root containment to `load_json_arg()` for scene indexing.
- `webfission-creative/scripts/data_modules/style_sampler.py`: pass project-root containment to `load_json_arg()` for scene extraction.
- `webfission-creative/scripts/data_modules/tests/test_coverage_boost.py`: extend existing `cli_args` tests.

### Knowledge Query

- `webfission-creative/scripts/data_modules/knowledge_query.py`: query production `relationship_events.type` while returning stable JSON for callers.
- `webfission-creative/scripts/data_modules/tests/test_knowledge_query.py`: use production schema, not mock-only `relationship_type`.

### State Manager

- `webfission-creative/scripts/data_modules/state_manager.py`: route `set_chapter_status()` through locked merge semantics.
- `webfission-creative/scripts/data_modules/tests/test_chapter_status.py`: preserve status monotonicity.
- `webfission-creative/scripts/data_modules/tests/test_state_manager_extra.py`: add merge regression for existing disk state.

### Vector Projection/RAG

- `webfission-creative/scripts/data_modules/vector_projection_writer.py`: add summary and scene chunks to commit projection, and avoid `asyncio.run()` failure when projection is invoked from an active event loop.
- `webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py`: cover summary/scene chunk generation, stable IDs, and active-event-loop storage bridge.

### Review Skill Flow

- `webfission-creative/skills/webnovel-review/SKILL.md`: switch to `review-pipeline --save-metrics`, remove obsolete second save command.
- `webfission-creative/skills/webnovel-write/SKILL.md`: verify already uses `--save-metrics`; no change unless wording drifts.

### Local Security Defaults

- `webfission-creative/dashboard/app.py`: restrict CORS to localhost origins, add file size limit for read API.
- `webfission-creative/scripts/backup_manager.py`: ensure generated `.gitignore` excludes `.env`.
- `webfission-creative/scripts/data_modules/style_sampler.py`: tolerate corrupt JSON in `tags`.
- New or existing tests under `webfission-creative/scripts/tests/` or `webfission-creative/scripts/data_modules/tests/` for these fixes.
...
**Files:**
- Modify: `webfission-creative/scripts/data_modules/cli_args.py`
- Modify: `webfission-creative/scripts/data_modules/index_manager.py`
- Modify: `webfission-creative/scripts/data_modules/state_manager.py`
- Modify: `webfission-creative/scripts/data_modules/sql_state_manager.py`
- Modify: `webfission-creative/scripts/data_modules/memory/store.py`
- Modify: `webfission-creative/scripts/data_modules/rag_adapter.py`
- Modify: `webfission-creative/scripts/data_modules/style_sampler.py`
- Test: `webfission-creative/scripts/data_modules/tests/test_coverage_boost.py`

- [ ] **Step 1: Add failing containment tests**

Append these tests to the `cli_args` section of `webfission-creative/scripts/data_modules/tests/test_coverage_boost.py`:
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_coverage_boost.py::test_load_json_arg_rejects_file_outside_base_dir webfission-creative/scripts/data_modules/tests/test_coverage_boost.py::test_load_json_arg_allows_file_inside_base_dir webfission-creative/scripts/data_modules/tests/test_coverage_boost.py::test_load_json_arg_stdin_ignores_base_dir -q --no-cov
```
...
Update `webfission-creative/scripts/data_modules/cli_args.py`:
...
In `webfission-creative/scripts/data_modules/index_manager.py`, update all `load_json_arg(...)` calls in command handlers, for example:
...
In `webfission-creative/scripts/data_modules/state_manager.py`:

```python
        data = load_json_arg(args.data, base_dir=args.project_root)
```

In `webfission-creative/scripts/data_modules/sql_state_manager.py`:

```python
        data = load_json_arg(args.data, base_dir=args.project_root)
```

In `webfission-creative/scripts/data_modules/memory/store.py`:

```python
        payload = load_json_arg(args.data, base_dir=args.project_root)
```

In `webfission-creative/scripts/data_modules/rag_adapter.py`:

```python
        scenes = load_json_arg(args.scenes, base_dir=args.project_root)
```

In `webfission-creative/scripts/data_modules/style_sampler.py`:
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_coverage_boost.py webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py -q --no-cov
```
...
```bash
git add webfission-creative/scripts/data_modules/cli_args.py webfission-creative/scripts/data_modules/index_manager.py webfission-creative/scripts/data_modules/state_manager.py webfission-creative/scripts/data_modules/sql_state_manager.py webfission-creative/scripts/data_modules/memory/store.py webfission-creative/scripts/data_modules/rag_adapter.py webfission-creative/scripts/data_modules/style_sampler.py webfission-creative/scripts/data_modules/tests/test_coverage_boost.py
...
**Files:**
- Modify: `webfission-creative/scripts/chapter_commit.py`
- Modify: `webfission-creative/scripts/data_modules/chapter_commit_service.py`
- Modify: `webfission-creative/scripts/data_modules/event_projection_router.py`
- Test: `webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py`
- Test: `webfission-creative/scripts/data_modules/tests/test_projection_writers.py`

- [ ] **Step 1: Add failing service test for rejected projection**

Append this test to `webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py`:
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py::test_apply_projections_updates_state_for_rejected_commit -q --no-cov
```
...
Update `webfission-creative/scripts/data_modules/event_projection_router.py`:
...
Update the start of `ChapterCommitService.apply_projections()` in `webfission-creative/scripts/data_modules/chapter_commit_service.py`:
...
Update `webfission-creative/scripts/chapter_commit.py`:
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py webfission-creative/scripts/data_modules/tests/test_projection_writers.py -q --no-cov
```
...
```bash
git add webfission-creative/scripts/chapter_commit.py webfission-creative/scripts/data_modules/chapter_commit_service.py webfission-creative/scripts/data_modules/event_projection_router.py webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py
...
**Files:**
- Modify: `pytest.ini`
- Verify: existing async tests under `webfission-creative/scripts/data_modules/tests/test_rag_adapter.py`
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_rag_adapter.py::test_store_and_search -q --no-cov
```
...
```ini
[pytest]
testpaths = webfission-creative/scripts/data_modules/tests webfission-creative/scripts/tests
pythonpath = webfission-creative/scripts
asyncio_mode = auto
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_rag_adapter.py -q --no-cov
```
...
**Files:**
- Modify: `webfission-creative/scripts/data_modules/knowledge_query.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_knowledge_query.py`
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_knowledge_query.py -q --no-cov
```
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_knowledge_query.py webfission-creative/scripts/data_modules/tests/test_webnovel_unified_cli.py -q --no-cov
```
...
```bash
git add webfission-creative/scripts/data_modules/knowledge_query.py webfission-creative/scripts/data_modules/tests/test_knowledge_query.py
...
**Files:**
- Modify: `webfission-creative/scripts/data_modules/state_manager.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_state_manager_extra.py`
- Verify: `webfission-creative/scripts/data_modules/tests/test_chapter_status.py`
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_chapter_status.py webfission-creative/scripts/data_modules/tests/test_state_manager_extra.py::test_set_chapter_status_uses_locked_save_state webfission-creative/scripts/data_modules/tests/test_state_manager_extra.py::test_set_chapter_status_preserves_existing_disk_state -q --no-cov
```
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_chapter_status.py webfission-creative/scripts/data_modules/tests/test_state_manager_extra.py -q --no-cov
```
...
```bash
git add webfission-creative/scripts/data_modules/state_manager.py webfission-creative/scripts/data_modules/tests/test_state_manager_extra.py
...
**Files:**
- Modify: `webfission-creative/scripts/data_modules/vector_projection_writer.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py`
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py::test_collect_chunks_includes_summary_and_scenes -q --no-cov
```
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py webfission-creative/scripts/data_modules/tests/test_rag_adapter.py -q --no-cov
```
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py::test_run_store_coro_works_inside_active_event_loop -q --no-cov
```
...
In `webfission-creative/scripts/data_modules/vector_projection_writer.py`, add imports:
...
```bash
git add webfission-creative/scripts/data_modules/vector_projection_writer.py webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py
...
**Files:**
- Modify: `webfission-creative/skills/webnovel-review/SKILL.md`
- Verify: `webfission-creative/skills/webnovel-write/SKILL.md`
...
```bash
rg -n "save-review-metrics|--save-metrics" webfission-creative/skills/webnovel-review/SKILL.md webfission-creative/skills/webnovel-write/SKILL.md
```
...
```bash
git add webfission-creative/skills/webnovel-review/SKILL.md
...
**Files:**
- Modify: `webfission-creative/dashboard/app.py`
- Modify: `webfission-creative/scripts/backup_manager.py`
- Test: add `webfission-creative/scripts/tests/test_dashboard_security.py`
- Test: add `webfission-creative/scripts/tests/test_backup_manager.py`

- [ ] **Step 1: Add dashboard security tests**

Create `webfission-creative/scripts/tests/test_dashboard_security.py`:
...
Create `webfission-creative/scripts/tests/test_backup_manager.py`:
...
```bash
python -m pytest webfission-creative/scripts/tests/test_dashboard_security.py webfission-creative/scripts/tests/test_backup_manager.py -q --no-cov
```
...
```bash
git add webfission-creative/dashboard/app.py webfission-creative/scripts/backup_manager.py webfission-creative/scripts/tests/test_dashboard_security.py webfission-creative/scripts/tests/test_backup_manager.py
...
**Files:**
- Modify: `webfission-creative/scripts/data_modules/style_sampler.py`
- Modify: `webfission-creative/scripts/data_modules/tests/test_style_sampler_cli.py`
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_style_sampler_cli.py::test_style_sampler_ignores_corrupt_tag_json -q --no-cov
```
...
```bash
python -m pytest webfission-creative/scripts/data_modules/tests/test_style_sampler_cli.py -q --no-cov
```
...
```bash
git add webfission-creative/scripts/data_modules/style_sampler.py webfission-creative/scripts/data_modules/tests/test_style_sampler_cli.py
...
```bash
python -m compileall -q webfission-creative/scripts webfission-creative/dashboard
```
...
```bash
python -m pytest \
  webfission-creative/scripts/data_modules/tests/test_chapter_commit_service.py \
  webfission-creative/scripts/data_modules/tests/test_coverage_boost.py \
  webfission-creative/scripts/data_modules/tests/test_projection_writers.py \
  webfission-creative/scripts/data_modules/tests/test_knowledge_query.py \
  webfission-creative/scripts/data_modules/tests/test_chapter_status.py \
  webfission-creative/scripts/data_modules/tests/test_state_manager_extra.py \
  webfission-creative/scripts/data_modules/tests/test_vector_projection_writer.py \
  webfission-creative/scripts/data_modules/tests/test_style_sampler_cli.py \
  webfission-creative/scripts/tests/test_dashboard_security.py \
  webfission-creative/scripts/tests/test_backup_manager.py \
  -q --no-cov
```
...
```bash
rg -n "save-review-metrics|review-pipeline|--save-metrics" webfission-creative/skills/webnovel-review/SKILL.md webfission-creative/skills/webnovel-write/SKILL.md
```
