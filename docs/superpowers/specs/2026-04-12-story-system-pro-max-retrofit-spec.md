...
[`reference_search.py`](D:/wk/novel%20skill/webfission-creative/webfission-creative/scripts/reference_search.py) 当前已经稳定承担以下职责：
...
- [`test_reference_search.py`](D:/wk/novel%20skill/webfission-creative/webfission-creative/scripts/tests/test_reference_search.py)
...
现有 CSV 契约已在 [`README.md`](D:/wk/novel%20skill/webfission-creative/webfission-creative/references/csv/README.md) 中明确，当前内容量也已经较大。
...
2. `WORKSPACE_ROOT`
   - Hermes 工作区根目录
   - 通过 `.hermes/.webnovel-current-project` 指针解析当前书项目
3. `PROJECT_ROOT`
   - 真实书项目根目录
